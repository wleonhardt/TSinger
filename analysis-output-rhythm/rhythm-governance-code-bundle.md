# Rhythm Governance Code Bundle

## src/audio/authoring/compile.ts
...
export function isLastBeatOfBar(beat: number, meter: MeterSpec): boolean {
...
## src/audio/authoring/sections.ts
...
## src/audio/presets/glassGarden.ts
...
function buildGlassMasterPlan(): PhrasePlan {
  ...
  const leadLayers = withRhythmRole("flow", withVoiceId("lead", [
    {
      kind: "motif" as const,
      id: "glass-i-call",
...
## src/audio/presets/lowTideMemory.ts
...
## src/audio/presets/paperLanterns.ts
...
## src/audio/presets/quietArcade.ts
...
## src/audio/testing/collectEvents.ts
...
## src/audio/testing/symbolicAnalysis.ts
